...
Пакет можно использовать для WEB сайтов на Laravel с использованием blade(взяв уже готовую компоненту), так и в качестве
API, вы можете отключить в конфигурации опцию `web_route_enabled`, и реализовать свою логику использования ассистента.
